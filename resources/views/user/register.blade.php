            ...
            <div class=" main-content-area">
                <div class="wrap-login-item ">
                    <div class="register-form form-item ">
                        <form class="form-stl" action="{{url('create-account')}}" name="frm-login" method="POST" >
                            @csrf
                            ...
                            <fieldset class="wrap-input item-width-in-half ">
                                ...
                                <input type="text" id="frm-reg-cfpass" name="confirm_password" placeholder="Confirm Password">
                            </fieldset>
