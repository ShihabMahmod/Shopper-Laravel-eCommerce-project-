...
<head>
        ...
        <link rel="stylesheet" href="{{asset('asset/css/matrix-login.css')}}" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="index.html">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span><input autocomplete="off" type="password" placeholder="Password" />
                        </div>
                    </div>
                </div>
        ...
        <script src="{{asset('asset(js/matrix.login.js')}}"></script> 
    </body>
